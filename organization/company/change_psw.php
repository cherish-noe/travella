				...
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right dev-page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar" id="cbp-spmenu-s1">
					<div class="scrollbar scrollbar1">
						<ul class="nav" id="side-menu">
                            ...
                            <li>
								<a href="#"><i class="fa fa-book nav_icon"></i>Update <span class="fa arrow"></span></a>
								<ul class="nav nav-second-level collapse">
									<li>
										<a href="profile_update.php"><i class="fa fa-reddit-alien nav_icon"></i>Profile Update</a>
									</li>
									<li>
										<a href="bus_update.php"><i class="fa fa-pencil nav_icon"></i>Bus Update</a>
									</li>
                                    <li>
										<a href="trip_tour_update.php"><i class="glyphicon glyphicon-edit nav_icon"></i>Trip & Tour Update</a>
									</li>
								</ul>
								<!-- /nav-second-level -->
							</li>
							...
							<ul>
								<li class="dropdown profile_details_drop">
									...
									<ul class="dropdown-menu drp-mnu">
										<li> <a href="#"><i class="fa fa-user" style="color:#196619"></i> Profile</a> </li> 
